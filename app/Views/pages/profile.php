...
<div class="container mt-4">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <p class="card-text">
                            <h1 class="text-center mb-4">Tentang CV. Djaya Aspalt</h1>
                            <h3 class="text-center mb-4">Kontraktor Aspal Jalan Terpercaya & Berpengalaman</h3>
    ...
    <div class="card mb-4">
        <div class="card-body text-center mb-4">
            <h2 class="card-title">Profil Djaya Aspalt</h2>
            <p class="card-text">
